...
# Train XGBoost model
xgb_model = xgb.XGBRegressor(objective='reg:squarederror', random_state=0, n_estimators=100, learning_rate=0.1)
...
joblib.dump(xgb_model, '/content/drive/MyDrive/OOP/xgboost_model.pkl')
joblib.dump(label_encoder, '/content/drive/MyDrive/OOP/label_encoder_XGBOOST.pkl')
